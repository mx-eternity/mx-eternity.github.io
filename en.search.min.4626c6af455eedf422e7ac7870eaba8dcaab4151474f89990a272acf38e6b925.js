...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3dada2ebab53b4aff1793f2886420b4caf43116be8cb10beb722d9a4380bf51c.js',function(){input.required=false;search();});}
