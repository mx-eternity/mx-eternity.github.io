...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ed8932bf765d9a09f7b44921a6fae80fc6d931ea5d93ab7db95e81aaea954322.js',function(){input.required=false;search();});}
